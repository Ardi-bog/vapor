...
$(window).on("load", function(){
    ...
    var barChartoption = {
        ...
        dataset: {
            source: [
                /*['product', 'Bulan 1', 'Bulan 2', 'Bulan 3'],*/
				['product'],
                ['Produk 1', randomize(), randomize(), randomize()],
                ['Produk 2', randomize(), randomize(), randomize()],
                ['Produk 3', randomize(), randomize(), randomize()],
                ['Produk 4', randomize(), randomize(), randomize()],
            ],
        },
