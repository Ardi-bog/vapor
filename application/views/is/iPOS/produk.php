                        ...
                        <table class="table data-thumb-view">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-img">
                                     <div class="avatar avatar-xl">
                                            <img src="app-assets/images/pages/eCommerce/3.png" style="max-height:70px">
                                     </div> 
                                    ...
                                    <td>
                                        <div class="chip chip-danger">
                                            <div class="chip-body">
                                                <div class="chip-text">10</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="product-price">Rp.0.000.000</td>
                                    <td class="product-price">Rp.0.000.000</td>
                                ...
                                <tr>
                                    ...
                                    <td class="product-img">
                                     <div class="avatar avatar-xl">
                                            <img src="app-assets/images/pages/eCommerce/5.png" style="max-height:70px">
                                     </div> 
                                     Beats HeadPhones                              
                                    </td>
                                    <td class="product-category">Computers</td>
                                    ...
                                    <td class="product-price">Rp.000.000</td>
                                    <td class="product-price">Rp.000.000</td>
                                    <td class="product-action d-print-none">
                                        <span class="action-edit btn btn-sm btn-success">
                                        	<i class="feather icon-edit font-medium-1"></i></span>
                                ...
                                <tr>
                                    ...
                                    <td class="product-img">
                                     <div class="avatar avatar-xl">
                                            <img src="app-assets/images/pages/eCommerce/1.png" style="max-height:70px">
                                     </div> 
                                    ...
                                    <td class="product-price">Rp.0.000</td>
                                    <td class="product-price">Rp.0.000</td>
                                    <td class="product-action d-print-none">
                                        <span class="action-edit btn btn-sm btn-success">
                                        	<i class="feather icon-edit font-medium-1"></i></span>
                                ...
                                <tr>
                                    ...
                                    <td class="product-img">
                                     <div class="avatar avatar-xl">
                                            <img src="app-assets/images/pages/eCommerce/12.png" style="max-height:70px">
                                     </div> 
                                    ...
                                    <td class="product-price">Rp.00.000</td>
                                    <td class="product-price">Rp.00.000</td>
                                    <td class="product-action d-print-none">
                                        <span class="action-edit btn btn-sm btn-success">
                                        	<i class="feather icon-edit font-medium-1"></i></span>
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <div class="add-new-data">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                <div>
                                    <h4 class="text-uppercase">Produk</h4>
                                </div>
