                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Silakan masukkan kata sandi baru.</p>
                                            ...
                                            <div class="card-body pt-1">
                                                <form>
                                                    ...
                                                    <fieldset class="form-label-group">
                                                        ...
                                                        <label for="user-confirm-password">Setujui password</label>
                                                    </fieldset>
                                                    <div class="row pt-2">
                                                        <div class="col-12 col-md-6 mb-1">
                                                            <a href="../login.php" class="btn btn-outline-primary btn-block px-0">Kembali ke Login</a>
                                                        </div>
                                                        <div class="col-12 col-md-6 mb-1">
                                                            <button type="submit" class="btn btn-primary btn-block px-0">Kirim</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
