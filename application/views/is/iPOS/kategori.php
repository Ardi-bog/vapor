                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                <tr>
                                    <td></td>
                                    <td class="product-name">00001</td>
                                    <td class="product-category">Computers</td>
                                    <td class="product-action d-print-none">
                                        <a href="#" class="action-edit btn btn-danger btn-sm">
                                           <i class="feather icon-edit font-medium-1"></i></a>
                                        <a href="#" class="action-delete btn btn-success btn-sm">
                                           <i class="feather icon-trash-2 font-medium-1"></i></a>
                                    </td>
                                </tr>
                                ...
                                <div class="data-fields px-2 mt-3">
                                    <div class="row">
                                        <div class="col-sm-12 data-field-col">
                                            ...
                                            <input type="text" class="form-control" id="data-name">                                        </div>
                                    </div>
                                </div>
                            </div>
