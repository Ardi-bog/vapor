                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center pl-0 pr-3 py-0">
                                    <img src="../../iPOS/app-assets/images/pages/register.jpg" alt="branding logo">
                                </div>
                                    ...
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form action="../../iPOS/html/ltr/horizontal-menu-template/index.html">
                                                        ...
                                                        <div class="col-12">
                                                            <fieldset class="checkbox">
                                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                                    ...
                                                                    <span class="">Saya menerima syarat & ketentuan.</span>
                                                                </div>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                    <a href="../../iPOS/login.php" class="btn btn-outline-primary float-left btn-inline mb-50">Login</a>
