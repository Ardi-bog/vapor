         ...
         <div class="card-body">
            ...
            <table class='table table-condensed table-bordered'>
              ...
              <tbody>
                ...
                <?php $no++; $total+=(int)$row[SUB_TOTAL_HARGA]; endforeach ?>
                <tr>
                  <td colspan="4" class="text-right" style="padding-right: 80px;font-size: 2em"> <strong>Total</strong></td>
                  <td class="text-center" style="font-size: 2em"><strong><?= $total ?></strong></td>
                  <td>
                    <?php if ($total !=0){ ?>
                        <?php 
