...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/asset/admin/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo base_url(); ?>/asset/admin/app-assets/images/pages/login.png">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <p class="px-2">Silahkan Registrasi Untuk Akun Anda.</p>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                            <form action="<?php echo site_url('market/prosesregistrasi');?>" method="post">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <!-- <div class="text-right"><a href="<?php echo base_url().$this->uri->segment(1); ?>/home" class="card-link">Login</a></div> -->
                                                    </div>
                                                    <a href="<?php echo base_url().$this->uri->segment(1); ?>/home" class="btn btn-outline-primary float-left btn-inline">Login</a>
                                                    <button name='submit' type="submit" class="btn btn-primary float-right btn-inline">Registrasi</button>
                                                </form>
                                            </div>
                                        </div>
