                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <form action="<?php echo site_url('market/proseslogin');?>" method="post">
                                                <?php 
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <!-- <div class="text-right"><a href="../lupa_pass.php" class="card-link">Login</a></div> -->
                                                    </div>
                                                    <a href="<?php echo base_url().$this->uri->segment(1); ?>/register" class="btn btn-outline-primary float-left btn-inline">Daftar</a>
