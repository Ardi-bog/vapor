                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                <a class='btn btn-warning btn-xs' title='Edit Data' data-toggle='modal' data-target='#myModaledit".$row[ID_JENIS_MENU]."'><span class='glyphicon glyphicon-edit'></span></a>
                                ";

                                if ($this->session->level == 'super-admin') {
                                    echo "
                                    <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url().$this->uri->segment(1)."/delete_jenismenu/$row[ID_JENIS_MENU]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-trash'></span></a>";
                                }
                                echo "
                              </center></td>
