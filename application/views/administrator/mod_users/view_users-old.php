            <div class="col-xs-12">  
              <div class="box box-default">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-default btn-sm' href='<?php echo base_url().$this->uri->segment(1); ?>/tambah_manajemenuser'>Tambahkan Data</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "
                              <td><center>
                                <a class='btn btn-warning btn-xs' title='Edit Data' href='".base_url().$this->uri->segment(1)."/edit_manajemenuser/$row[USERNAME]'><span class='glyphicon glyphicon-edit'></span></a>";

                                if ($this->session->level == 'super-admin' && $row[USERNAME] != 'superadmin') {
                                  if ($row[STATUS_AKUN] == 0) {
                                    echo "
                                    <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url().$this->uri->segment(1)."/delete_manajemenuser/$row[USERNAME]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-trash'></span></a>";
                                  }
                                }
                                echo "
                              </center></td>
