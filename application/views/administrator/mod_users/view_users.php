...
<!-- Data list view starts -->
  ...
  <div class="float-right">
    <input class="form-control" id="myInputSearch" type="text" placeholder="Search..">
  </div>
                       ...
                       echo "</td>
                          ...
                          <div class='modal fade' id='myModal".$no."'>
                            <div class='modal-dialog'>
                              ...
                              <form class='form-horizontal' role='form' method='POST' action='".base_url('administrator/ganti_status_manajemenuser'); echo "'>
                    ...
                    <div class='modal fade' id='myModaledit".$row[ID_USERNYA]."'>
                        <div class='modal-dialog modal-dialog-scrollable modal-lg'>
                          <div class='modal-content'>
                            ...
                            <!-- Modal body -->
                            <div class='modal-body'>
                          <form class='form-horizontal' enctype='multipart/form-data' role='form' method='POST' action='".base_url('administrator/manajemenuser'). "'>
                                ...
                                <div class='form-group'>
                                   ...
                                   <label for='b' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Password</label>
                                    ...
                                    <label for='nama' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Nama Admin</label>
                                    <div>
                              ...
                              echo " </div><br>
                                    ...
                                    <label for='f' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Foto Admin</label>
                                    <div style='margin-left: 20px;width: 90%;'>
                                  ...
                                  echo "<label for='level' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Level user</label>
                                    <div style='margin-left: 20px;width: 90%;'>";
                                        if ($row[LEVEL_USERS] == 'admin' ) {
                                          echo "
                                                <input type='radio' name='level' value='admin' checked> Administrator &nbsp;
                                                <input type='radio' name='level' value='admin-wilayah'> Admin Wilayah";
                                        }else if ($row[LEVEL_USERS] == 'admin-wilayah' ) {
                                          echo "
                                                <input type='radio' name='level' value='admin'> Administrator &nbsp;
                                                <input type='radio' name='level' value='admin-wilayah' checked> Admin Wilayah";
                                        }
                                  echo " </div><br>"; 
                    ...
                    <div class='modal fade' id='myModaldelete".$row[ID_USERNYA]."'>
                      <div class='modal-dialog'>
                        <div class='modal-content'>
                          ...
                          <div class='modal-footer'>
                            <button type='button' class='btn btn-secondary' data-dismiss='modal'>Batal</button>
                            <a href='".base_url().$this->uri->segment(1)."/delete_manajemenuser/$row[ID_USERNYA]' id='delete' class='btn btn-primary'>Hapus</a> </div>
                        </div>
                    </div>
                    ";
                $no++;
