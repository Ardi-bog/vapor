                       ...
                       echo "</td>
                          ...
                          <div class='modal fade' id='myModal".$no."'>
                            <div class='modal-dialog'>
                              ...
                              <form class='form-horizontal' role='form' method='POST' action='".base_url('administrator/ganti_status_kurir'); echo "'>
                    ...
                    <div class='modal fade' id='myModaledit".$row[ID_USERNYA]."'>
                        <div class='modal-dialog modal-dialog-scrollable modal-lg'>
                          <div class='modal-content'>
                            ...
                            <!-- Modal body -->
                            <div class='modal-body'>
                          <form class='form-horizontal' enctype='multipart/form-data' role='form' method='POST' action='".base_url('administrator/kurir'). "'>
                                ...
                                <div class='form-group'>
                                   ...
                                   <label for='b' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Password</label>
                                    ...
                                    <div>
                                        <input type='text' style='margin-left: 20px;width: 90%;' class='form-control' name='nama' required value='".$row[NAMA_KURIR]."'>
                                    </div><br>

                                    <label for='no_hp' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Nomor Hp</label>
                                    <div>
                                        <input type='number' style='margin-left: 20px;width: 90%;' class='form-control' name='no_hp' required value='".$row[TELEPON]."'>
                                    </div><br>

                                    <label for='alamat' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Alamat Lengkap</label>
                                    <div style='margin-left: 20px;width: 90%;'>
                                        <textarea rows='4' cols='50' name='alamat' required>$row[ALAMAT]</textarea>
                                    </div><br>

                                    <label for='f' style='margin-left: 20px;margin-bottom: 10px;' class='control-label'>Foto Kurir</label>
                                    <div style='margin-left: 20px;width: 90%;'>
                    ...
                    <div class='modal fade' id='myModaldelete".$row[ID_USERNYA]."'>
                      <div class='modal-dialog'>
                        <div class='modal-content'>
                          ...
                          <div class='modal-footer'>
                            <button type='button' class='btn btn-secondary' data-dismiss='modal'>Batal</button>
                            <a href='".base_url().$this->uri->segment(1)."/delete_kurir/$row[USERNAME]' id='delete' class='btn btn-primary'>Hapus</a> </div>
                        </div>
                    </div>
                    ";
                $no++;
          ...
          <?php 
            echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Kurir</th>             <td><input type='text' class='form-control' name='nama' required></td></tr>
                    <tr><th scope='row'>No HP</th>               <td><input type='number' class='form-control' name='no_hp' required></td></tr>
                    <tr><th scope='row'>Alamat Lengkap</th>               <td><textarea rows='4' cols='50' name='alamat' placeholder='Alamat Desa, Jalan, dan No Rumah/Kantor dan Kecamatan ..' required></textarea></td></tr>
