  ...
  <head>
    ...
    <style type="text/css">
      .login-page, .register-page {
          background-image: url('<?php echo base_url(); ?>/asset/login/coba1.jpg');
          background-position: center;
          background-repeat: no-repeat;
          background-size: cover;
      }
      .login-box-body, .register-box-body {
          background-image: url('<?php echo base_url(); ?>/asset/login/bg-index.jpg');
          color: #fff !important;
      }
      .linkx {
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><img width="150px;" src="<?php echo base_url(); ?>/asset/login/Logo.png"></a>
      </div><!-- /.login-logo -->
        ...
        ?>
          ...
          <div class="row">
            <div class="col-xs-8" style="margin-top: 8px;">
              <a class='link linkx' data-dismiss="modal" aria-hidden="true" data-toggle='modal' href='#lupapass' data-target='#lupapass'>Anda Lupa Password?</a>
            </div><!-- /.col -->
            <div class="col-xs-4">
              <input name='submit' type="submit" class="btn btn-default btn-block btn-flat" value='Sign In'>
            </div><!-- /.col -->
          </div>
        </form>
