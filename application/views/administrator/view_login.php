                                            ...
                                            <div class="card-body pt-1">
                                                ...
                                                ?>
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" name='a' class="form-control" id="user-name" placeholder="Username" required>
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                        <input type="password" name='b' class="form-control" id="user-password" placeholder="Password" required>
                                                        <div class="form-control-position">
                                                    ...
                                                    <a href="../register.php" class="btn btn-outline-primary float-left btn-inline">Daftar</a>
                                                    <button name='submit' type="submit" class="btn btn-primary float-right btn-inline">Login</button>
                                                </form>
                                            </div>
                                        </div>
