...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Apr 2021 pada 15.40
...
(1, 'vaporhitz', 'web@gmail.com', 'https://web.facebook.com/', 'https://www.instagram.com/', '', '', '0877662', 'ini deskripsi vapor', 'map'),
...
('VPR', 256, 'Toko Vapor', 'vaporhitz', 1);
...
CREATE TABLE `rb_penjualan` (
  ...
  `KEMBALI` varchar(100) DEFAULT NULL,
...
INSERT INTO `rb_penjualan` (`NO_FAKTUR_PENJUALAN`, `TGL_PENJUALAN`, `ID_USER_KASIR`, `NAMA_PELANGGAN`, `NOMOR_MEJA`, `TOTAL_HARGA`, `KEMBALI`, `CATATAN`, `KET`, `STATUS`) VALUES
('NCTNB202104180001', '2021-04-18', 1, 'coba dikri', 1, '15000', '5000', '', 'offline', 'belum'),
('NCTNB202104190001', '2021-04-19', 1, 'coba dikri 2', 2, '158100', '41900', '', 'offline', 'belum'),
...
('VPR202104190001', '2021-04-19', 1, NULL, NULL, '34000', '1000', '', 'offline', 'selesai'),
('VPR202104190002', '2021-04-19', 1, NULL, NULL, '34000', '', '', 'offline', 'selesai');
...
INSERT INTO `rb_penjualan_detail` (`ID_PENJUALAN_DETAIL`, `NO_FAKTUR_PENJUALAN`, `ID_PRODUK`, `NAMA_PRODUK`, `JUMLAH`, `HARGA`, `DISKON`, `SUB_TOTAL_HARGA`) VALUES
...
(13, 'NCTNB202104180001', 1, 'Chicken Wing', 1, 15000, 0, 15000),
(14, 'NCTNB202104190001', 1, 'Chicken Wing', 10, 15000, 0, 150000),
(15, 'NCTNB202104190001', 17, 'Apple sparkle', 1, 8100, 10, 8100),
(16, 'VPR202104190001', 2, 'Produk 2', 2, 17000, 0, 34000),
(17, 'VPR202104190002', 2, 'Produk 2', 2, 17000, 0, 34000);
...
(2, 0, 2, 12, 4, 8, '2021-04-19 16:12:55'),
